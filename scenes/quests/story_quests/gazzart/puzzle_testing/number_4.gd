...
@export_node_path("Sprite2D") var sprite_path: NodePath = NodePath("ColllsionNumber4/SpriteNumber4")
@export var valor_boton: int = 4
...
func _on_interaction_started(_player: Player, _from_right: bool) -> void:
	if _boton_usado:
		print("Number4: ignorando interacción, ya fue utilizado")
